...
const generationPipelineSteps = [
  ...
  { id: "ice", run: IceModule.steps.ice },
  ...
  { id: "states", run: StatesModule.steps.states },
  { id: "routes", run: () => Routes.generate() },
  { id: "religions", run: () => Religions.generate() },
  { id: "burgsSpecify", run: () => Burgs.specify() },
  { id: "stateStatistics", run: StatesModule.steps.stateStatistics },
  { id: "stateForms", run: StatesModule.steps.stateForms },
  ...
  { id: "taxes", run: StatesModule.steps.taxes },
  { id: "military", run: MilitaryModule.steps.military },
